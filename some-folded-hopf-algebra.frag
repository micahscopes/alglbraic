...
#info Free module generated by {(1,7,6,5,4,3,2), (1,6,4,2,7,5,3), (1,5,2,6,3,7,4), (1,3)(4,7)(5,6)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[0]*v[1] + u[0]*v[2] + u[0]*v[3] + u[1]*v[0] + u[2]*v[0] + u[3]*v[0], -u[1]*v[3] - u[2]*v[2] + u[2]*v[3] - u[3]*v[1] + u[3]*v[2], -u[1]*v[2] - u[2]*v[1] + u[3]*v[3], -u[1]*v[1]);
}
