...
#define providesInit
#define SubframeMax 20
#define IterationsBetweenRedraws 20

#info Free module generated by {(1,8,5,2)(3,16,10,12)(4,14,11,7)(6,9,13,15), (1,15)(2,16)(3,11)(4,10)(5,9)(6,14)(7,13)(8,12), (1,14,5,7)(2,4,8,11)(3,13,10,6)(9,16,15,12), (1,16,11,6)(2,9,14,10)(3,8,15,7)(4,13,5,12), (1,13,11,12)(2,3,14,15)(4,16,5,6)(7,9,8,10)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[3]*v[1] - u[4]*v[3], -u[0]*v[3] - u[3]*v[2], -u[1]*v[3] - u[3]*v[4], u[0]*v[0] + u[0]*v[1] + u[0]*v[2] + u[0]*v[4] + u[1]*v[0] + u[1]*v[1] + u[1]*v[2] + u[1]*v[4] + u[2]*v[0] + u[2]*v[1] + u[2]*v[2] + u[2]*v[4] - u[3]*v[3] + u[4]*v[0] + u[4]*v[1] + u[4]*v[2] + u[4]*v[4], -u[2]*v[3] - u[3]*v[0]);
}


float norm(float u[N]) {
    return pow(pow(abs(u[0]), 2.0) + pow(abs(u[1]), 2.0) + pow(abs(u[2]), 2.0) + pow(abs(u[3]), 2.0) + pow(abs(u[4]), 2.0), 0.5);
}
...
void initMutations() {
    int mutationBtime = int(mutationB*time);
	MA = permutation(mutationA);
	MB = permutation(mutationBtime);
