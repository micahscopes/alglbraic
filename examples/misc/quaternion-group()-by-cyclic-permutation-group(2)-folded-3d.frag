...
#info 7 dimensional fractal quest on Free module generated by {(1,6,3,8)(2,5,4,7), (1,7,3,5)(2,6,4,8), (1,4,3,2)(5,8,7,6), (1,3)(2,4)(5,7)(6,8)(9,10), (1,8,3,6)(2,7,4,5)(9,10), (1,4,3,2)(5,8,7,6)(9,10), (1,7,3,5)(2,6,4,8)(9,10)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[1]*v[1] + u[1]*v[2] + u[2]*v[1] + u[2]*v[2] + u[3]*v[3] + u[3]*v[6] + u[4]*v[4] + u[4]*v[5] + u[5]*v[4] + u[5]*v[5] + u[6]*v[3] + u[6]*v[6], -u[0]*v[2] - u[2]*v[0] + u[3]*v[4] - u[4]*v[3] + u[5]*v[6] - u[6]*v[5], -u[0]*v[1] - u[1]*v[0] + u[3]*v[5] + u[4]*v[6] - u[5]*v[3] - u[6]*v[4], u[0]*v[6] - u[1]*v[4] - u[2]*v[5] + u[4]*v[1] + u[5]*v[2] + u[6]*v[0], -u[0]*v[5] + u[1]*v[3] - u[2]*v[6] - u[3]*v[1] - u[5]*v[0] + u[6]*v[2], -u[0]*v[4] - u[1]*v[6] + u[2]*v[3] - u[3]*v[2] - u[4]*v[0] + u[6]*v[1], u[0]*v[3] + u[1]*v[5] + u[2]*v[4] + u[3]*v[0] - u[4]*v[2] - u[5]*v[1]);
}
