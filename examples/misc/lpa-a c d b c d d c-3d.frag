...
#info leavitt path algebra of with dimension 19, for graph(a1*b1 + a5*b10 + a6*b11 + a1*b15 + a1*b16, a7*b12 + a8*b13 + a2*b17 + a2*b18 + a2*b2, a3*b3, a9*b14 + a4*b19 + a4*b4, a5*b3 + a1*b5, a6*b4 + a1*b6, a7*b3 + a2*b7, a8*b4 + a2*b8, a9*b3 + a4*b9, a10*b1 + a3*b10, a11*b1 + a4*b11, a3*b12 + a12*b2, a4*b13 + a13*b2, a3*b14 + a14*b4, -a6*b11 - a1*b16, -a5*b10 - a1*b15, -a8*b13 - a2*b18, -a7*b12 - a2*b17, 0)
...
uniform int FrameX; slider[1,1,19]
uniform int FrameY; slider[1,2,19]
uniform int FrameZ; slider[1,3,19]

// sign involutions
uniform int flipperA; slider[0,0,524288]
uniform int flipperB; slider[0,0,524288]
uniform int flipperC; slider[0,0,524288]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[14] + u[0]*v[15] + u[4]*v[9] + u[5]*v[10], u[1]*v[16] + u[1]*v[17] + u[1]*v[1] + u[6]*v[11] + u[7]*v[12], u[2]*v[2], u[3]*v[18] + u[3]*v[3] + u[8]*v[13], u[0]*v[4] + u[4]*v[2], u[0]*v[5] + u[5]*v[3], u[1]*v[6] + u[6]*v[2], u[1]*v[7] + u[7]*v[3], u[3]*v[8] + u[8]*v[2], u[2]*v[9] + u[9]*v[0], u[10]*v[0] + u[3]*v[10], u[11]*v[1] + u[2]*v[11], u[12]*v[1] + u[3]*v[12], u[13]*v[3] + u[2]*v[13], -u[0]*v[15] - u[5]*v[10], -u[0]*v[14] - u[4]*v[9], -u[1]*v[17] - u[7]*v[12], -u[1]*v[16] - u[6]*v[11], 0);
}
...
float[N] loadParamsJuliaVect(out float u[N]){
    u[0] = JuliaVect1; u[1] = JuliaVect2; u[2] = JuliaVect3; u[3] = JuliaVect4; u[4] = JuliaVect5; u[5] = JuliaVect6; u[6] = JuliaVect7; u[7] = JuliaVect8; u[8] = JuliaVect9; u[9] = JuliaVect10; u[10] = JuliaVect11; u[11] = JuliaVect12; u[12] = JuliaVect13; u[13] = JuliaVect14; u[14] = JuliaVect15; u[15] = JuliaVect16; u[16] = JuliaVect17; u[17] = JuliaVect18; u[18] = JuliaVect19; 
    return u;
}


float[N] loadParamsPosition(out float u[N]){
    u[0] = Position1; u[1] = Position2; u[2] = Position3; u[3] = Position4; u[4] = Position5; u[5] = Position6; u[6] = Position7; u[7] = Position8; u[8] = Position9; u[9] = Position10; u[10] = Position11; u[11] = Position12; u[12] = Position13; u[13] = Position14; u[14] = Position15; u[15] = Position16; u[16] = Position17; u[17] = Position18; u[18] = Position19; 
    return u;
}
