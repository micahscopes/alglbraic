...
#info 3 dimensional fractal quest on Free module generated by {(1,4)(2,5)(3,6), (1,5,3)(2,6,4), (1,6,5,4,3,2)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[1]*v[2] + u[2]*v[1], -u[0]*v[2] - u[1]*v[1] - u[2]*v[0] + u[2]*v[2], -u[0]*v[1] - u[1]*v[0]);
}


float pNormSq(float u[N],p) {
    float normSq = 0;
    for(int i=0; i<N; i++){
