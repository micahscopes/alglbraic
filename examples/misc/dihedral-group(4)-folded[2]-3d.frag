...
#info 4 dimensional fractal quest on Free module generated by {(1,3)(2,4), (2,4), (1,4,3,2), (1,2)(3,4)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[2] + u[1]*v[3] - u[2]*v[0] - u[3]*v[1], -u[0]*v[3] - u[1]*v[2] - u[2]*v[1] + u[3]*v[0], -u[0]*v[0] - u[1]*v[1] - u[2]*v[2] + u[3]*v[3], -u[0]*v[1] + u[1]*v[0] - u[2]*v[3] - u[3]*v[2]);
}
