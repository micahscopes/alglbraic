...
#info leavitt path algebra of with dimension 13, for graph(a1*b1 + a1*b11 + a5*b8, a2*b2, a3*b12 + a3*b3 + a6*b9, a7*b10 + a4*b13 + a4*b4, a5*b2 + a1*b5, a6*b2 + a3*b6, a7*b2 + a4*b7, a8*b1 + a2*b8, a9*b3 + a2*b9, a2*b10 + a10*b4, 0, 0, 0)
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[10] + u[4]*v[7], u[1]*v[1], u[2]*v[11] + u[2]*v[2] + u[5]*v[8], u[3]*v[12] + u[3]*v[3] + u[6]*v[9], u[0]*v[4] + u[4]*v[1], u[2]*v[5] + u[5]*v[1], u[3]*v[6] + u[6]*v[1], u[1]*v[7] + u[7]*v[0], u[1]*v[8] + u[8]*v[2], u[1]*v[9] + u[9]*v[3], 0, 0, 0);
}
