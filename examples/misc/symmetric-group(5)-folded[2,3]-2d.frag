...
#info 6 dimensional fractal quest on Free module generated by {(1,3,2)(4,5), (3,5), (1,3,4,2,5), (1,2)(3,5), (3,5,4), (1,2)(3,5,4)} over Symbolic Ring
#group Algebraic
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] - u[0]*v[3] - u[1]*v[2] - u[2]*v[1] + u[2]*v[2] - u[2]*v[4] - u[3]*v[0] + u[4]*v[2] - u[4]*v[4] - u[5]*v[0] + u[5]*v[5], -u[1]*v[3] - u[3]*v[1] + u[5]*v[4], -u[0]*v[1] + u[0]*v[2] - u[0]*v[4] - u[1]*v[0] + u[2]*v[0] - u[2]*v[3] - u[3]*v[2] + u[4]*v[0] + u[4]*v[5] - u[5]*v[2], -u[1]*v[1] - u[3]*v[3], -u[1]*v[5] + u[2]*v[5] - u[3]*v[4] - u[4]*v[3] + u[5]*v[1], u[0]*v[5] - u[1]*v[4] - u[3]*v[5] + u[4]*v[1] - u[5]*v[3]);
}
