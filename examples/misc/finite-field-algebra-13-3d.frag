...
#info Algebra of finite field of dimension 13
...
uniform int FrameX; slider[1,1,13]
uniform int FrameY; slider[1,2,13]
uniform int FrameZ; slider[1,3,13]

// sign involutions
uniform int flipperA; slider[0,0,8192]
uniform int flipperB; slider[0,0,8192]
uniform int flipperC; slider[0,0,8192]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[10] + u[0]*v[11] + u[0]*v[12] + u[0]*v[1] + u[0]*v[2] + u[0]*v[3] + u[0]*v[4] + u[0]*v[5] + u[0]*v[6] + u[0]*v[7] + u[0]*v[8] + u[0]*v[9] + u[10]*v[0] + u[11]*v[0] + u[12]*v[0] + u[1]*v[0] + u[2]*v[0] + u[3]*v[0] + u[4]*v[0] + u[5]*v[0] + u[6]*v[0] + u[7]*v[0] + u[8]*v[0] + u[9]*v[0], u[10]*v[4] + u[11]*v[6] + u[12]*v[12] + u[1]*v[1] + u[2]*v[7] + u[3]*v[9] + u[4]*v[10] + u[5]*v[8] + u[6]*v[11] + u[7]*v[2] + u[8]*v[5] + u[9]*v[3], u[10]*v[8] + u[11]*v[12] + u[12]*v[11] + u[1]*v[2] + u[2]*v[1] + u[3]*v[5] + u[4]*v[7] + u[5]*v[3] + u[6]*v[9] + u[7]*v[4] + u[8]*v[10] + u[9]*v[6], u[10]*v[12] + u[11]*v[5] + u[12]*v[10] + u[1]*v[3] + u[2]*v[8] + u[3]*v[1] + u[4]*v[4] + u[5]*v[11] + u[6]*v[7] + u[7]*v[6] + u[8]*v[2] + u[9]*v[9], u[10]*v[3] + u[11]*v[11] + u[12]*v[9] + u[1]*v[4] + u[2]*v[2] + u[3]*v[10] + u[4]*v[1] + u[5]*v[6] + u[6]*v[5] + u[7]*v[8] + u[8]*v[7] + u[9]*v[12], u[10]*v[7] + u[11]*v[4] + u[12]*v[8] + u[1]*v[5] + u[2]*v[9] + u[3]*v[6] + u[4]*v[11] + u[5]*v[1] + u[6]*v[3] + u[7]*v[10] + u[8]*v[12] + u[9]*v[2], u[10]*v[11] + u[11]*v[10] + u[12]*v[7] + u[1]*v[6] + u[2]*v[3] + u[3]*v[2] + u[4]*v[8] + u[5]*v[9] + u[6]*v[1] + u[7]*v[12] + u[8]*v[4] + u[9]*v[5], u[10]*v[2] + u[11]*v[3] + u[12]*v[6] + u[1]*v[7] + u[2]*v[10] + u[3]*v[11] + u[4]*v[5] + u[5]*v[4] + u[6]*v[12] + u[7]*v[1] + u[8]*v[9] + u[9]*v[8], u[10]*v[6] + u[11]*v[9] + u[12]*v[5] + u[1]*v[8] + u[2]*v[4] + u[3]*v[7] + u[4]*v[2] + u[5]*v[12] + u[6]*v[10] + u[7]*v[3] + u[8]*v[1] + u[9]*v[11], u[10]*v[10] + u[11]*v[2] + u[12]*v[4] + u[1]*v[9] + u[2]*v[11] + u[3]*v[3] + u[4]*v[12] + u[5]*v[7] + u[6]*v[8] + u[7]*v[5] + u[8]*v[6] + u[9]*v[1], u[10]*v[1] + u[11]*v[8] + u[12]*v[3] + u[1]*v[10] + u[2]*v[5] + u[3]*v[12] + u[4]*v[9] + u[5]*v[2] + u[6]*v[6] + u[7]*v[7] + u[8]*v[11] + u[9]*v[4], u[10]*v[5] + u[11]*v[1] + u[12]*v[2] + u[1]*v[11] + u[2]*v[12] + u[3]*v[8] + u[4]*v[6] + u[5]*v[10] + u[6]*v[4] + u[7]*v[9] + u[8]*v[3] + u[9]*v[7], u[10]*v[9] + u[11]*v[7] + u[12]*v[1] + u[1]*v[12] + u[2]*v[6] + u[3]*v[4] + u[4]*v[3] + u[5]*v[5] + u[6]*v[2] + u[7]*v[11] + u[8]*v[8] + u[9]*v[10]);
}
...
float[N] loadParamsJuliaVect(out float u[N]){
    u[0] = JuliaVect1; u[1] = JuliaVect2; u[2] = JuliaVect3; u[3] = JuliaVect4; u[4] = JuliaVect5; u[5] = JuliaVect6; u[6] = JuliaVect7; u[7] = JuliaVect8; u[8] = JuliaVect9; u[9] = JuliaVect10; u[10] = JuliaVect11; u[11] = JuliaVect12; u[12] = JuliaVect13; 
    return u;
}


float[N] loadParamsPosition(out float u[N]){
    u[0] = Position1; u[1] = Position2; u[2] = Position3; u[3] = Position4; u[4] = Position5; u[5] = Position6; u[6] = Position7; u[7] = Position8; u[8] = Position9; u[9] = Position10; u[10] = Position11; u[11] = Position12; u[12] = Position13; 
    return u;
}
