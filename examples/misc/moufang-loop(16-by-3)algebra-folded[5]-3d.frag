...
#info fractal quest on algebra formed from 4 dimensional loop:Free algebra quotient on 16 generators ('x1', 'x2', 'x3', 'x4', 'x5', 'x6', 'x7', 'x8', 'x9', 'x10', 'x11', 'x12', 'x13', 'x14', 'x15', 'x16') and dimension 16 over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[1]*v[1] + u[2]*v[3] + u[3]*v[2], u[0]*v[1] + u[1]*v[0] + u[2]*v[2] + u[3]*v[3], u[0]*v[2] + u[1]*v[3] + u[2]*v[0] + u[3]*v[1], u[0]*v[3] + u[1]*v[2] + u[2]*v[1] + u[3]*v[0]);
}
