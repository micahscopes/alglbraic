...
#info Free module generated by {(1,5,4)(2,3,6), (1,3,5,6,4,2), (1,6)(2,5)(3,4)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[1]*v[2] - u[2]*v[1], u[0]*v[0] - u[0]*v[2] - u[1]*v[1] - u[2]*v[0], u[0]*v[1] + u[1]*v[0] - u[2]*v[2]);
}
