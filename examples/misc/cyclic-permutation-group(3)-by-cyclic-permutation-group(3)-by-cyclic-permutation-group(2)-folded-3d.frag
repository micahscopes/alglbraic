...
#info 9 dimensional fractal quest on Free module generated by {(7,8), (4,6,5), (1,3,2), (4,6,5)(7,8), (1,3,2)(4,5,6), (1,3,2)(7,8), (1,3,2)(4,6,5), (1,2,3)(4,6,5)(7,8), (1,3,2)(4,6,5)(7,8)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[3]*v[6] + u[6]*v[3], u[0]*v[2] - u[1]*v[1] + u[2]*v[0] - u[2]*v[2] + u[3]*v[5] - u[3]*v[8] + u[5]*v[3] - u[8]*v[3], u[0]*v[1] + u[1]*v[0] - u[1]*v[2] - u[2]*v[1] + u[3]*v[4] - u[3]*v[7] + u[4]*v[3] - u[7]*v[3], -u[0]*v[6] - u[1]*v[8] - u[2]*v[7] + u[4]*v[8] + u[5]*v[7] - u[6]*v[0] - u[7]*v[2] + u[7]*v[5] - u[8]*v[1] + u[8]*v[4], u[0]*v[5] + u[1]*v[6] - u[4]*v[4] + u[5]*v[0] - u[5]*v[5] + u[6]*v[1] - u[6]*v[7] - u[7]*v[6], u[0]*v[4] + u[2]*v[6] + u[4]*v[0] - u[4]*v[5] - u[5]*v[4] + u[6]*v[2] - u[6]*v[8] - u[8]*v[6], -u[0]*v[3] + u[1]*v[7] + u[2]*v[8] - u[3]*v[0] + u[3]*v[3] - u[4]*v[7] - u[5]*v[8] - u[6]*v[6] + u[7]*v[1] - u[7]*v[4] + u[8]*v[2] - u[8]*v[5], u[0]*v[8] + u[1]*v[4] - u[2]*v[3] + u[2]*v[5] - u[3]*v[2] + u[4]*v[1] - u[4]*v[6] + u[5]*v[2] - u[6]*v[4] - u[7]*v[7] + u[8]*v[0] - u[8]*v[8], u[0]*v[7] - u[1]*v[3] + u[1]*v[5] + u[2]*v[4] - u[3]*v[1] + u[4]*v[2] + u[5]*v[1] - u[5]*v[6] - u[6]*v[5] + u[7]*v[0] - u[7]*v[8] - u[8]*v[7]);
}


float norm(float u[N]) {
    return pow(pow(abs(u[0]), 2.0) + pow(abs(u[1]), 2.0) + pow(abs(u[2]), 2.0) + pow(abs(u[3]), 2.0) + pow(abs(u[4]), 2.0) + pow(abs(u[5]), 2.0) + pow(abs(u[6]), 2.0) + pow(abs(u[7]), 2.0) + pow(abs(u[8]), 2.0), 0.5);
}
