...
#info leavitt path algebra of with dimension <function dimension at 0x7f8f79c33b90>, for graph[a1*b1 + a1*b10 + a4*b7, a2*b11 + a2*b12 + a2*b2 + a5*b8 + a6*b9, a3*b3, a4*b2 + a1*b4, a5*b2 + a2*b5, a6*b3 + a2*b6, a7*b1 + a2*b7, a8*b2 + a2*b8, a9*b2 + a3*b9, -a2*b12 - a6*b9, -a2*b11 - a5*b8]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[9] + u[3]*v[6], u[1]*v[10] + u[1]*v[11] + u[1]*v[1] + u[4]*v[7] + u[5]*v[8], u[2]*v[2], u[0]*v[3] + u[3]*v[1], u[1]*v[4] + u[4]*v[1], u[1]*v[5] + u[5]*v[2], u[1]*v[6] + u[6]*v[0], u[1]*v[7] + u[7]*v[1], u[2]*v[8] + u[8]*v[1], -u[1]*v[11] - u[5]*v[8], -u[1]*v[10] - u[4]*v[7],0);
}
