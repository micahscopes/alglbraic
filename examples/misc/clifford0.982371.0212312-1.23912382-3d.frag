...
#info Clifford Algebra with signature [0.98237,1.0212312,-1.23912382]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + 0.98237*u[1]*v[1] - 1.003226893944*u[2]*v[2] + 1.24312234115062*u[3]*v[3] + 1.2172780670534*u[4]*v[4] + 1.0212312*u[5]*v[5] + 1.26543190564718*u[6]*v[6] - 1.23912382*u[7]*v[7], u[0]*v[1] + u[1]*v[0] + 1.0212312*u[2]*v[5] + 1.26543190564718*u[3]*v[6] - 1.23912382*u[4]*v[7] - 1.0212312*u[5]*v[2] + 1.26543190564718*u[6]*v[3] + 1.23912382*u[7]*v[4], u[0]*v[2] + u[1]*v[5] + u[2]*v[0] - 1.23912382*u[3]*v[7] + 1.23912382*u[4]*v[6] - u[5]*v[1] - 1.23912382*u[6]*v[4] - 1.23912382*u[7]*v[3], u[0]*v[3] + u[1]*v[6] + u[2]*v[7] + u[3]*v[0] - u[4]*v[5] - u[5]*v[4] + u[6]*v[1] + u[7]*v[2], u[0]*v[4] + u[1]*v[7] + 1.0212312*u[2]*v[6] - 1.0212312*u[3]*v[5] + u[4]*v[0] - 1.0212312*u[5]*v[3] - 1.0212312*u[6]*v[2] - u[7]*v[1], u[0]*v[5] + 0.98237*u[1]*v[2] - 0.98237*u[2]*v[1] - 1.2172780670534*u[3]*v[4] - 1.2172780670534*u[4]*v[3] + u[5]*v[0] - 1.23912382*u[6]*v[7] + 1.23912382*u[7]*v[6], u[0]*v[6] + 0.98237*u[1]*v[3] - 0.98237*u[2]*v[4] + 0.98237*u[3]*v[1] + 0.98237*u[4]*v[2] + u[5]*v[7] + u[6]*v[0] - u[7]*v[5], u[0]*v[7] + 0.98237*u[1]*v[4] - 1.003226893944*u[2]*v[3] - 1.003226893944*u[3]*v[2] - 0.98237*u[4]*v[1] + 1.0212312*u[5]*v[6] - 1.0212312*u[6]*v[5] + u[7]*v[0]);
}
