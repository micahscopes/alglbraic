...
#info leavitt path algebra of with dimension 19, for graph(a1*b1 + a5*b10 + a1*b15, a6*b11 + a2*b16 + a2*b2, a7*b12 + a3*b17 + a3*b3, a8*b13 + a9*b14 + a4*b18 + a4*b19 + a4*b4, a5*b3 + a1*b5, a6*b3 + a2*b6, a7*b4 + a3*b7, a8*b1 + a4*b8, a9*b2 + a4*b9, a10*b1 + a3*b10, a3*b11 + a11*b2, a4*b12 + a12*b3, a1*b13 + a13*b4, a2*b14 + a14*b4, 0, 0, 0, -a9*b14 - a4*b19, -a8*b13 - a4*b18)
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[14] + u[4]*v[9], u[1]*v[15] + u[1]*v[1] + u[5]*v[10], u[2]*v[16] + u[2]*v[2] + u[6]*v[11], u[3]*v[17] + u[3]*v[18] + u[3]*v[3] + u[7]*v[12] + u[8]*v[13], u[0]*v[4] + u[4]*v[2], u[1]*v[5] + u[5]*v[2], u[2]*v[6] + u[6]*v[3], u[3]*v[7] + u[7]*v[0], u[3]*v[8] + u[8]*v[1], u[2]*v[9] + u[9]*v[0], u[10]*v[1] + u[2]*v[10], u[11]*v[2] + u[3]*v[11], u[0]*v[12] + u[12]*v[3], u[13]*v[3] + u[1]*v[13], 0, 0, 0, -u[3]*v[18] - u[8]*v[13], -u[3]*v[17] - u[7]*v[12]);
}
