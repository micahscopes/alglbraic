...
#info 7 dimensional fractal quest on Free module generated by {(1,8)(2,9)(3,10)(4,11)(5,12)(6,13)(7,14), (1,9,3,11,5,13,7)(2,10,4,12,6,14,8), (1,10,5,14,9,4,13,8,3,12,7,2,11,6), (1,11,7,3,13,9,5)(2,12,8,4,14,10,6), (1,12,9,6,3,14,11,8,5,2,13,10,7,4), (1,13,11,9,7,5,3)(2,14,12,10,8,6,4), (1,14,13,12,11,10,9,8,7,6,5,4,3,2)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[1]*v[6] + u[2]*v[5] + u[3]*v[4] + u[4]*v[3] + u[5]*v[2] + u[6]*v[1], -u[0]*v[6] - u[1]*v[5] - u[2]*v[4] + u[2]*v[6] - u[3]*v[3] + u[3]*v[5] - u[4]*v[2] + u[4]*v[4] - u[5]*v[1] + u[5]*v[3] - u[6]*v[0] + u[6]*v[2], -u[0]*v[5] - u[1]*v[4] - u[2]*v[3] - u[3]*v[2] + u[3]*v[6] - u[4]*v[1] + u[4]*v[5] - u[5]*v[0] + u[5]*v[4] + u[6]*v[3], -u[0]*v[4] - u[1]*v[3] - u[2]*v[2] - u[3]*v[1] - u[4]*v[0] + u[4]*v[6] + u[5]*v[5] + u[6]*v[4], -u[0]*v[3] - u[1]*v[2] - u[2]*v[1] - u[3]*v[0] + u[5]*v[6] + u[6]*v[5], -u[0]*v[2] - u[1]*v[1] - u[2]*v[0] + u[6]*v[6], -u[0]*v[1] - u[1]*v[0]);
}


float norm(float u[N]) {
    return pow(pow(abs(u[0]), 2.0) + pow(abs(u[1]), 2.0) + pow(abs(u[2]), 2.0) + pow(abs(u[3]), 2.0) + pow(abs(u[4]), 2.0) + pow(abs(u[5]), 2.0) + pow(abs(u[6]), 2.0), 0.5);
}
