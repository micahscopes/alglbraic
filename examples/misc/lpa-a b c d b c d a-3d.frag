...
#info leavitt path algebra of with dimension 16, for graph(a1*b1 + a1*b13 + a5*b9, a6*b10 + a2*b14 + a2*b2, a7*b11 + a3*b15 + a3*b3, a8*b12 + a4*b16 + a4*b4, a5*b2 + a1*b5, a6*b3 + a2*b6, a7*b4 + a3*b7, a8*b1 + a4*b8, a9*b1 + a2*b9, a3*b10 + a10*b2, a4*b11 + a11*b3, a1*b12 + a12*b4, 0, 0, 0, 0)
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[12] + u[4]*v[8], u[1]*v[13] + u[1]*v[1] + u[5]*v[9], u[2]*v[14] + u[2]*v[2] + u[6]*v[10], u[3]*v[15] + u[3]*v[3] + u[7]*v[11], u[0]*v[4] + u[4]*v[1], u[1]*v[5] + u[5]*v[2], u[2]*v[6] + u[6]*v[3], u[3]*v[7] + u[7]*v[0], u[1]*v[8] + u[8]*v[0], u[2]*v[9] + u[9]*v[1], u[10]*v[2] + u[3]*v[10], u[0]*v[11] + u[11]*v[3], 0, 0, 0, 0);
}
