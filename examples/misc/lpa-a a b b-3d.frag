...
#info leavitt path algebra of with dimension <function dimension at 0x7fb50dd14b90>, for graph[a1*b1 + a3*b5 + a1*b7, a2*b2 + a4*b6 + a2*b8, a3*b1 + a1*b3, a4*b2 + a2*b4, a5*b1 + a1*b5, a6*b2 + a2*b6]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[6] + u[2]*v[4], u[1]*v[1] + u[1]*v[7] + u[3]*v[5], u[0]*v[2] + u[2]*v[0], u[1]*v[3] + u[3]*v[1], u[0]*v[4] + u[4]*v[0], u[1]*v[5] + u[5]*v[1],0,0);
}
