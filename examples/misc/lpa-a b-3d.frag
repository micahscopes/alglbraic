...
#info leavitt path algebra of with dimension <function dimension at 0x7f2798a88b90>, for graph[a1*b1 + a3*b4 + a1*b5, a2*b2, a3*b2 + a1*b3, a4*b1 + a2*b4]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[4] + u[2]*v[3], u[1]*v[1], u[0]*v[2] + u[2]*v[1], u[1]*v[3] + u[3]*v[0],0);
}
