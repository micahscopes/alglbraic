...
#info 5 dimensional fractal quest on Free module generated by {(1,6)(2,7)(3,8)(4,9)(5,10), (1,7,3,9,5)(2,8,4,10,6), (1,8,5,2,9,6,3,10,7,4), (1,9,7,5,3)(2,10,8,6,4), (1,10,9,8,7,6,5,4,3,2)} over Symbolic Ring
#group Algebraic
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[1]*v[4] + u[2]*v[3] + u[3]*v[2] + u[4]*v[1], -u[0]*v[4] - u[1]*v[3] - u[2]*v[2] + u[2]*v[4] - u[3]*v[1] + u[3]*v[3] - u[4]*v[0] + u[4]*v[2], -u[0]*v[3] - u[1]*v[2] - u[2]*v[1] - u[3]*v[0] + u[3]*v[4] + u[4]*v[3], -u[0]*v[2] - u[1]*v[1] - u[2]*v[0] + u[4]*v[4], -u[0]*v[1] - u[1]*v[0]);
}
