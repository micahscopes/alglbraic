...
uniform int mutationA; slider[0,0,5040]
uniform int mutationB; slider[0,0,5040]
uniform int mutationC; slider[0,0,5040]
uniform int mutationD; slider[0,0,5040]
...
float[N] product(float u[N], float v[N]) {
    return float[N](1.0*u[0]*v[0], u[1]*v[0] + u[2]*v[1], 1.0*u[2]*v[2], u[3]*v[0] + u[4]*v[1] + u[5]*v[3], u[4]*v[2] + u[5]*v[4], 1.0*u[5]*v[5], 1.0*u[6]*v[6]);
}


float norm(float u[N]) {
    return pow(pow(u[0], 2.0) + pow(u[1], 2.0) + pow(u[2], 2.0) + pow(u[3], 2.0) + pow(u[4], 2.0) + pow(u[5], 2.0) + pow(u[6], 2.0), 0.5);
}
