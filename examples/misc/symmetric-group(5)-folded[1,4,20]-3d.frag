...
#info 10 dimensional fractal quest on Free module generated by {(1,5,3,4), (1,3,5,4), (1,3,4,2,5), (1,4,3,5,2), (1,4,5,3), (1,3,5,4,2), (1,5)(2,4), (1,5,3,4,2), (1,4,2,3), (1,2)(3,5,4)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] - u[2]*v[5] + u[5]*v[1] - u[5]*v[2] + u[5]*v[7] - u[5]*v[8] - u[6]*v[6] + u[8]*v[4] - u[9]*v[3] - u[9]*v[9], -u[0]*v[1] + u[2]*v[6] - u[3]*v[5] + u[3]*v[9] - u[4]*v[2] + u[5]*v[0] - u[5]*v[4] + u[7]*v[3] - u[8]*v[7] - u[9]*v[8], -u[0]*v[2] + u[4]*v[0] - u[4]*v[1] - u[4]*v[3] - u[5]*v[6] + u[6]*v[9] - u[8]*v[5] - u[8]*v[8] - u[9]*v[4] - u[9]*v[7], -u[0]*v[3] + u[1]*v[1] - u[1]*v[2] + u[1]*v[9] + u[6]*v[0] - u[6]*v[4] + u[7]*v[7] - u[7]*v[8] + u[8]*v[6] - u[9]*v[5], -u[0]*v[4] - u[1]*v[5] - u[1]*v[6] - u[2]*v[7] + u[3]*v[3] + u[6]*v[8] + u[8]*v[0] - u[8]*v[1] - u[8]*v[9] - u[9]*v[2], -u[0]*v[5] - u[2]*v[8] + u[4]*v[6] + u[5]*v[9] + u[6]*v[3] + u[6]*v[7] + u[7]*v[0] - u[7]*v[4] - u[8]*v[2] - u[9]*v[1], -u[0]*v[6] - u[1]*v[3] + u[2]*v[9] - u[3]*v[7] + u[3]*v[8] - u[4]*v[4] - u[7]*v[1] + u[7]*v[2] + u[7]*v[5] + u[9]*v[0], -u[0]*v[7] + u[2]*v[0] - u[2]*v[1] - u[2]*v[4] - u[3]*v[6] - u[4]*v[8] + u[6]*v[2] + u[6]*v[5] + u[7]*v[9] - u[8]*v[3], -u[0]*v[8] + u[1]*v[0] - u[2]*v[2] - u[3]*v[4] - u[4]*v[7] - u[4]*v[9] + u[5]*v[3] - u[5]*v[5] + u[6]*v[1] + u[9]*v[6], -u[0]*v[9] + u[1]*v[4] + u[1]*v[7] - u[1]*v[8] - u[2]*v[3] - u[3]*v[0] + u[3]*v[1] - u[3]*v[2] - u[4]*v[5] - u[7]*v[6]);
}
