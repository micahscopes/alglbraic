...
#info leavitt path algebra of with dimension <function dimension at 0x7f01e6ff9b90>, for graph[a1*b1 + a1*b11 + a1*b12 + a3*b7 + a4*b8, a6*b10 + a2*b13 + a2*b14 + a2*b2 + a5*b9, a3*b1 + a1*b3, a4*b2 + a1*b4, a5*b1 + a2*b5, a6*b2 + a2*b6, a7*b1 + a1*b7, a8*b1 + a2*b8, a9*b2 + a1*b9, a2*b10 + a10*b2, -a1*b12 - a4*b8, -a1*b11 - a3*b7, -a6*b10 - a2*b14, -a2*b13 - a5*b9]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[10] + u[0]*v[11] + u[2]*v[6] + u[3]*v[7], u[1]*v[12] + u[1]*v[13] + u[1]*v[1] + u[4]*v[8] + u[5]*v[9], u[0]*v[2] + u[2]*v[0], u[0]*v[3] + u[3]*v[1], u[1]*v[4] + u[4]*v[0], u[1]*v[5] + u[5]*v[1], u[0]*v[6] + u[6]*v[0], u[1]*v[7] + u[7]*v[0], u[0]*v[8] + u[8]*v[1], u[1]*v[9] + u[9]*v[1], -u[0]*v[11] - u[3]*v[7], -u[0]*v[10] - u[2]*v[6], -u[1]*v[13] - u[5]*v[9], -u[1]*v[12] - u[4]*v[8]);
}
