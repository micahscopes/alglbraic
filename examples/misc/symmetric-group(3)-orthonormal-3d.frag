...
#info 3 dimensional fractal quest on Symmetric group algebra of order 3 over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + 3*u[1]*v[1] + 2*u[2]*v[2], u[0]*v[1] + u[1]*v[0] + 2*u[1]*v[2] + 2*u[2]*v[1], u[0]*v[2] + 3*u[1]*v[1] + u[2]*v[0] + u[2]*v[2]);
}
