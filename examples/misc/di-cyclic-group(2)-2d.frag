...
#info 8 dimensional fractal quest on Group algebra of Diyclic group of order 8 as a permutation group over Symbolic Ring
#group Algebraic
...
float[N] antipode(float u[N]) {
    return float[N](u[0], u[3], u[2], u[1], u[6], u[7], u[4], u[5]);
}
