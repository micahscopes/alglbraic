...
#info 6 dimensional fractal quest on Free module generated by {(1,5)(2,6)(3,7)(4,8), (1,7,5,3)(2,8,6,4), (1,8,5,4)(2,3,6,7), (1,6,5,2)(3,4,7,8), (1,6,3,8,5,2,7,4), (1,8,7,6,5,4,3,2)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](-u[0]*v[0] + u[1]*v[1] + u[1]*v[2] + u[1]*v[4] + u[2]*v[1] + u[2]*v[4] + u[2]*v[5] + u[3]*v[3] + u[4]*v[1] + u[4]*v[2] + u[4]*v[5] + u[5]*v[2] + u[5]*v[4] + u[5]*v[5], -u[0]*v[1] - u[1]*v[0] - u[3]*v[5] + u[5]*v[3], -u[0]*v[4] - u[2]*v[3] - u[3]*v[2] + u[3]*v[4] - u[4]*v[0] + u[4]*v[3], -u[0]*v[3] + u[1]*v[5] - u[2]*v[2] - u[3]*v[0] + u[4]*v[4] - u[5]*v[1], -u[0]*v[2] - u[2]*v[0], -u[0]*v[5] - u[1]*v[3] + u[3]*v[1] - u[5]*v[0]);
}
