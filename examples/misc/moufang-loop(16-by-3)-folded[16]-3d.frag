...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[1]*v[1] + u[2]*v[3] + u[3]*v[2] + u[4]*v[6] + u[5]*v[7] + u[6]*v[4] + u[7]*v[5], u[0]*v[1] + u[1]*v[0] + u[2]*v[2] + u[3]*v[3] + u[4]*v[4] + u[5]*v[5] + u[6]*v[6] + u[7]*v[7], u[0]*v[2] + u[1]*v[3] + u[2]*v[0] + u[3]*v[1] + u[4]*v[7] + u[5]*v[4] + u[6]*v[5] + u[7]*v[6], u[0]*v[3] + u[1]*v[2] + u[2]*v[1] + u[3]*v[0] + u[4]*v[5] + u[5]*v[6] + u[6]*v[7] + u[7]*v[4], u[0]*v[4] + u[1]*v[6] + u[2]*v[5] + u[3]*v[7] + u[4]*v[0] + u[5]*v[3] + u[6]*v[1] + u[7]*v[2], u[0]*v[5] + u[1]*v[7] + u[2]*v[6] + u[3]*v[4] + u[4]*v[2] + u[5]*v[0] + u[6]*v[3] + u[7]*v[1], u[0]*v[6] + u[1]*v[4] + u[2]*v[7] + u[3]*v[5] + u[4]*v[1] + u[5]*v[2] + u[6]*v[0] + u[7]*v[3], u[0]*v[7] + u[1]*v[5] + u[2]*v[4] + u[3]*v[6] + u[4]*v[3] + u[5]*v[1] + u[6]*v[2] + u[7]*v[0]);
}
