...
#info leavitt path algebra of with dimension <function dimension at 0x7f3a47153b90>, for graph[a1*b1 + a4*b6 + a5*b7 + a1*b8 + a1*b9, a2*b2, a3*b3, a4*b2 + a1*b4, a5*b3 + a1*b5, a6*b1 + a2*b6, a7*b1 + a3*b7, -a5*b7 - a1*b9, -a4*b6 - a1*b8]
...
// sign involutions
uniform int flipperA; slider[0,0,512]
uniform int flipperB; slider[0,0,512]
uniform int flipperC; slider[0,0,512]
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[7] + u[0]*v[8] + u[3]*v[5] + u[4]*v[6], u[1]*v[1], u[2]*v[2], u[0]*v[3] + u[3]*v[1], u[0]*v[4] + u[4]*v[2], u[1]*v[5] + u[5]*v[0], u[2]*v[6] + u[6]*v[0], -u[0]*v[8] - u[4]*v[6], -u[0]*v[7] - u[3]*v[5]);
}
