...
#info 3 dimensional fractal quest on Free module generated by {(1,2)(3,4), (1,2,3), (1,2,4)} over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] - u[1]*v[2] - u[2]*v[1], u[0]*v[1] - u[1]*v[0] - u[2]*v[2], u[0]*v[2] - u[1]*v[1] - u[2]*v[0]);
}
