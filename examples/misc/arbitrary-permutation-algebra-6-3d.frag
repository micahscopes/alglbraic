...
#info actions are random permutations, 6 dimensional real algebra with multiplication: (a1*b1+a3*b2+a1*b3+a5*b4+a2*b5+a3*b6) + (a2*b1+a4*b2+a3*b3+a3*b4+a1*b5+a4*b6)*E1 + (a3*b1+a1*b2+a5*b3+a1*b4+a5*b5+a2*b6)*E2 + (a4*b1+a2*b2+a2*b3+a6*b4+a6*b5+a5*b6)*E3 + (a5*b1+a6*b2+a6*b3+a2*b4+a3*b5+a6*b6)*E4 + (a6*b1+a5*b2+a4*b3+a4*b4+a4*b5+a1*b6)*E5
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[2] + u[1]*v[4] + u[2]*v[1] + u[2]*v[5] + u[4]*v[3], u[0]*v[4] + u[1]*v[0] + u[2]*v[2] + u[2]*v[3] + u[3]*v[1] + u[3]*v[5], u[0]*v[1] + u[0]*v[3] + u[1]*v[5] + u[2]*v[0] + u[4]*v[2] + u[4]*v[4], u[1]*v[1] + u[1]*v[2] + u[3]*v[0] + u[4]*v[5] + u[5]*v[3] + u[5]*v[4], u[1]*v[3] + u[2]*v[4] + u[4]*v[0] + u[5]*v[1] + u[5]*v[2] + u[5]*v[5], u[0]*v[5] + u[3]*v[2] + u[3]*v[3] + u[3]*v[4] + u[4]*v[1] + u[5]*v[0]);
}
