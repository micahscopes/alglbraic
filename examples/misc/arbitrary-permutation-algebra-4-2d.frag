...
#info actions are random permutations, 4 dimensional real algebra with multiplication: (a1*b1+a2*b2+a1*b3+a3*b4) + (a2*b1+a4*b2+a2*b3+a1*b4)*E1 + (a3*b1+a1*b2+a4*b3+a2*b4)*E2 + (a4*b1+a3*b2+a3*b3+a4*b4)*E3
#group Algebraic
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + u[0]*v[2] + u[1]*v[1] + u[2]*v[3], u[0]*v[3] + u[1]*v[0] + u[1]*v[2] + u[3]*v[1], u[0]*v[1] + u[1]*v[3] + u[2]*v[0] + u[3]*v[2], u[2]*v[1] + u[2]*v[2] + u[3]*v[0] + u[3]*v[3]);
}
