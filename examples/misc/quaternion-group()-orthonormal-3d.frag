...
#info 5 dimensional fractal quest on Group algebra of Quaternion group of order 8 as a permutation group over Symbolic Ring
...
float[N] product(float u[N], float v[N]) {
    return float[N](u[0]*v[0] + 2*u[1]*v[1] + u[2]*v[2] + 2*u[3]*v[3] + 2*u[4]*v[4], u[0]*v[1] + u[1]*v[0] + u[1]*v[2] + u[2]*v[1] + 2*u[3]*v[4] + 2*u[4]*v[3], u[0]*v[2] + 2*u[1]*v[1] + u[2]*v[0] + 2*u[3]*v[3] + 2*u[4]*v[4], u[0]*v[3] + 2*u[1]*v[4] + u[2]*v[3] + u[3]*v[0] + u[3]*v[2] + 2*u[4]*v[1], u[0]*v[4] + 2*u[1]*v[3] + u[2]*v[4] + 2*u[3]*v[1] + u[4]*v[0] + u[4]*v[2]);
}
